...
dcos-run:
	dcos spark run --submit-args='--num-executors 1 --executor-cores 1 --executor-memory 3G -Dspark.cassandra.connection.host=node-0.cassandra.mesos --class ai.legends.athena.Main https://s3-us-west-2.amazonaws.com/asuna-spark-jobs/legendsai-athena/legendsai-athena-latest.jar'
